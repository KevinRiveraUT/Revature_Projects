...
function getPenReq() {
    ...
    xhttp.open("POST", "http://ec2-18-218-227-97.us-east-2.compute.amazonaws.com:8090/ERS/html/certreq.ajax?status=PENDING", true);
...
function getDenReq() {
    ...
    //Opening connection for endpoint
    xhttp.open("POST", "http://ec2-18-218-227-97.us-east-2.compute.amazonaws.com:8090/ERS/html/certreq.ajax?status=DENIED", true);
...
function getAppReq() {
    ...
    //Opening connection for endpoint
    xhttp.open("POST", "http://ec2-18-218-227-97.us-east-2.compute.amazonaws.com:8090/ERS/html/certreq.ajax?status=APPROVED", true);
...
function insertRequest() {
    ...
    //Opening connection for endpoint
    xhttp.open("POST", "http://ec2-18-218-227-97.us-east-2.compute.amazonaws.com:8090/ERS/html/insertreq.ajax?amount=" + amount + "&purpose=" + purpose, true);
...
function modifyUser() {
    ...
    //Opening connection for endpoint
    xhttp.open("POST", "http://ec2-18-218-227-97.us-east-2.compute.amazonaws.com:8090/ERS/html/modifyuser.ajax?" + parameters, true);
